...
func (tx *Tx) init() {
	tx.TestEntity = NewTestEntityClient(tx.config)
	tx.TestEntityHistory = NewTestEntityHistoryClient(tx.config)
}
...
// applies a query, for example: TestEntity.QueryXXX(), the query will be executed
